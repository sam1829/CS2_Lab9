...
public class Woolie extends Thread {
    ...
    public void run()  {
        ...
        while (this.crossingTimeRemaining != 0)
        {
            ...
            else if (WoolieWipeout.nextInt(0,100) <= 100 / CHANCE_TO_FALL)
            {
                System.out.println("WOOLIE:" + this + " fell off the course!");
                obstacleCourse.fallOff();
                timesFallen += 1;
                obstacleCourse.leave(this);
                crossingTimeRemaining = this.getTotalCrossingTime();
                kraken.returnPreserver(this);
                obstacleCourse.enter(this);
                preserver = Optional.of(kraken.getPreserver(this));
            }
            else
            {
                ...
                System.out.println("WOOLIE:" + this + " is crossing the course!");
            }
        }
        obstacleCourse.leave(this);
        kraken.returnPreserver(this);
